...
if(isset($_GET["cat_id"])){
  try
{ $id = $_GET["cat_id"];
$sql = "DELETE FROM `catogries` WHERE cat_id = ?";
          ...
          $id= $k["cat_id"];
                       ...
                       ?>
                        <tr>
                          ...
                          <td> <a href="editcategory.php?cat_id=<?php  echo $k ["cat_id"];?>"><img src="./images/edit.png" alt="Edit"></td>
                          <td><a href="categories.php?cat_id=<?php  echo $k ["cat_id"];?>" onclick="return confirm('Are you sure you want to delete?')"><img src="./images/delete.png" alt="Delete"></td>
                        </tr>
                       <?php
        }?>
