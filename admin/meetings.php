...
if(isset($_GET["id"])){
  try
{ $id = $_GET["id"];
$sql = "DELETE FROM `add_meeting` WHERE id = ?";
                        ...
                        <tr>
                          ...
                          <td><?php   if( $active ==1 ){
                             ...
                             echo "Yes";
	                          	...
	                          	$active="";
                                         echo "No";} ?></td>
                          <td><a href="editmeeting.php?id=<?php  echo $k ["id"];?>"><img src="./images/edit.png" alt="Edit"></td>
                          <td><a href="meetings.php?id=<?php  echo $k ["id"];?>" onclick="return confirm('Are you sure you want to delete?')"><img src="./images/delete.png" alt="Delete"></td>
                        </tr>
                       <?php
                           }
