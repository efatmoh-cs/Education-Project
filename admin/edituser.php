...
if($_SERVER["REQUEST_METHOD"] === "GET"){
	...
	if(isset($_GET["id"])){
	  $id = $_GET["id"];
	  include_once("../includes/showedituser.php");
	}}
	elseif($_SERVER["REQUEST_METHOD"] === "POST"){
		...
		$sql = "UPDATE `usears` SET `fullname`=?,`user_name`=?,`email`=? ,`active`=?   WHERE  id =?";
		$stmtUpdate=$conn->prepare($sql);
		$stmtUpdate->execute([$name,$username,$email, $active,$id]);
									...
									<form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="fullname"  value="<?php echo  $fullname  ?>" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="user-name"  value="<?php echo $username  ?>" required="required" class="form-control">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox"  name="select" <?php echo $checked ?> class="flat">
												</label>
											</div>
										</div>
