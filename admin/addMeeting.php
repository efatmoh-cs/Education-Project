...
//$date = date("Y-m-d",strtotime($date));
   ...
   try{
    $sql = " INSERT INTO `add_meeting`( `meetingDate`, `title`, `content`, `location`, `price`,`image`,`published`,`cat_id`) VALUES (?,?,?,?,?,?,?,?)";
$stmt = $conn->prepare($sql);
$stmt->execute([$date,$title,$content,$location,$price,$image_name,$active,$category]);
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form  method="POST"  action=""  id="demo-form2"  enctype="multipart/form-data" class="form-horizontal form-label-left">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date"  name="meetingdate"    id="meeting-date" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
						...
						?>	
                        <option value="<?php echo $cat_idcar?>">  <?php echo $category?></option>
