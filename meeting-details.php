...
if(isset($_GET["id"])){
    ...
    try{
        ...
        echo "Failed get categories Data: " . $e->getMessage();
    }
}
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <a href="meeting-details.html"><img src="assets/images/<?php echo $image ?>" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="meeting-details.php"><h4><?php echo $content?></h4></a>
